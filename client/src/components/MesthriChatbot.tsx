...
export function MesthriChatbot() {
  ...
  return (
    <div className="fixed bottom-6 left-6 z-50 w-96 h-[500px] bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 flex flex-col">
      {/* Header */}
