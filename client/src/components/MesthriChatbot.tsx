...
export function MesthriChatbot() {
  ...
  if (!isOpen) {
    return (
      <div className="fixed left-6 z-50" style={{ bottom: '15px' }}>
        <Button
  ...
  return (
    <div className="fixed left-6 z-50 w-96 h-[500px] bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 flex flex-col" style={{ bottom: '15px' }}>
      {/* Header */}
